...
if __name__ == '__main__':
    ...
    # aggregate_all(dir='/home/data/jchengaj/crawled_question_answers/iter2_raw')
    ...
    # input_file_list.update({'/home/data/jchengaj/crawled_question_answers/contract_iter{}_output'})
